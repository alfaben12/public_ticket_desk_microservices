...
+function ($) {
  ...
  Spinner.prototype.change = function(value) {
    ...
    var e = $.Event('change.bs.spinner.html', { value: value })
    this.$element.trigger(e)

    e = $.Event('changed.bs.spinner.html')
  ...
  $.fn.spinner = function (option, arg) {
    return this.each(function () {
      var $this   = $(this)
      var data    = $this.data('bs.spinner.html')
      var isNew   = (typeof data == 'object')
      var options = typeof option == 'object' && option

      if (!data) $this.data('bs.spinner.html', (data = new Spinner(this, options)))
  ...
  $(document)
    .on('click.bs.spinner.data-api.html', '[data-toggle="spinner"][data-on!="mousehold"]', trigger)
    .on('mousehold.bs.spinner.data-api.html', '[data-toggle="spinner"]', trigger)
